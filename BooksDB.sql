...
create table Books_and_Bytes(book_title varchar(30), 
author varchar(30), genre varchar(30),
 publication_year int, price int) ;
 insert into Books_and_bytes values
 ...
 select * from Books_and_bytes;
 select book_title from Books_and_bytes;
 update Books_and_bytes set price = 1100 where price > 600;
 Delete from Books_and_bytes where book_title = "10-Day Green Smoothie Cleanse" ;
 select * from Books_and_bytes;
 select * from Books_and_bytes;
